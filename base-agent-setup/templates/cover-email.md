...
Quick next step before I start building your voice agent. I want to nail this on the first try, so rather than going back and forth on email about every detail, I've put together a structured brainstorm you can run with ChatGPT at your own pace. It lets you think out loud, gets us much richer detail than a Q&A would, and means the agent we build actually behaves the way you want it to from day one. Most people find it takes 20–40 minutes — comfortable cup-of-coffee territory, not a workshop.
...
--- ATTACH THIS FILE ALONGSIDE YOUR MESSAGE ---

{{CUSTOMER_CONTEXT_FILE_PATH}}
